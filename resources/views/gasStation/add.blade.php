...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {{--Start Form--}}
        <form  action="/saveGasStation" class="col-12" method="post" style="margin: 50px auto;background-color: #fff; padding: 30px;border-radius: 8px;" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input required name="name" type="text" class="form-control"  placeholder="Ex: Total ....">
                </div>
            </div>
            <div class="form-group row mb-5">
                <label for="inputPassword" style="padding-top: 5px;" class="col-sm-3 col-form-label">City </label>
                <div class="col-sm-9">
                    <input required name="city" type="text" class="form-control"  placeholder="Ex: Cairo , Giza ....">
                </div>
            </div>
            ...
            <div class="col-12 row p-0 m-0">
                <div class="col-md-6 m-0 p-0">
                   <div class="form-group row">
                       ...
                       <div class="col-sm-9">
                           <div class="custom-control custom-switch" style="margin-left: 11px;">
                               <input name="tier" type="checkbox" class="custom-control-input" id="customSwitch1" >
                   ...
                   <div class="form-group row">
                       ...
                       <div class="col-sm-9">
                           <div class="custom-control custom-switch" style="margin-left: 11px;">
                               <input name="blowair" type="checkbox" class="custom-control-input" id="customSwitch2" >
                   ...
                   <div class="form-group row">
                       ...
                       <div class="col-sm-9">
                           <div class="custom-control custom-switch" style="margin-left: 11px;">
                               <input name="p80" type="checkbox" class="custom-control-input" id="customSwitch3" >
                ...
                <div class="col-md-6 m-0 p-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="p92" type="checkbox" class="custom-control-input" id="customSwitch11" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="p95" type="checkbox" class="custom-control-input" id="customSwitch21" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="awheel" type="checkbox" class="custom-control-input" id="customSwitch31" >
            ...
            <div class="col-12 row p-0 m-0 ">
                <div class="col-md-6 m-0 p-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="solar" type="checkbox" class="custom-control-input" id="customSwitch4" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="gas" type="checkbox" class="custom-control-input" id="customSwitch5" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="carwashing" type="checkbox" class="custom-control-input" id="customSwitch6" >
                ...
                <div class="col-md-6 m-0 p-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="pnitro" type="checkbox" class="custom-control-input" id="customSwitch7" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="fixsus" type="checkbox" class="custom-control-input" id="customSwitch8" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-switch" style="margin-left: 11px;">
                                <input name="ochange" type="checkbox" class="custom-control-input" id="customSwitch9" >
            ...
            <div class="p-3 col-10 m-auto">
                ...
                <p class="m-0 p-0 col-12 mb-3 mt-2">
                    Address:
                    <input name="address" required  type="text" class="search_addr form-control form-control-sm" size="45" value="Egypt , Cairo">
                </p>
                <div class="col-12 row m-0 p-0">
                    <p class="col-md-6 m-0 p-0 pr-2">
                        Latitude:
                        <input required type="text" name="lat" class="search_latitude form-control form-control-sm" size="30" value="30.044420">
                    </p>
                    <p class="col-md-6 m-0 p-0 pl-2">
                        Longitude:
                        <input required type="text" name="long" class="search_longitude form-control form-control-sm" size="30" value="31.235712">
                    </p>
                </div>
