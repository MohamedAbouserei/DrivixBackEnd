...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {{--Start Form--}}
        <form  action="/saveSupervisor" class="col-12" method="post" style="margin: 50px auto;background-color: #fff; padding: 30px;border-radius: 8px;" enctype="multipart/form-data">
            <p class="text-center text-dark bg-light rounded p-2"> <i class="fas fa-users-cog pr-3"></i> Add New Supervisor </p>
            {{ csrf_field() }}
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required name="email" type="email" class="form-control"  placeholder="Ex: test@gmail.com ....">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required  name="passowrd" type="password" class="form-control"   placeholder="Ex  ***********">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required name="salary" type="number" class="form-control"   placeholder="4500 E.G">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required name="nationalID" type="number" class="form-control" placeholder="452135456465123">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required name="work_hours" type="number" class="form-control"  placeholder="6 hours">
                </div>
            </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <input required name="hire_date" type="date" class="form-control"  placeholder="8/11/2017">
                </div>
            </div>
